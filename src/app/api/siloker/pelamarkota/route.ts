...
export async function GET() {
  try {
    const responseAPI = await fetch(URL_DASHBOAD + 'teras-tenaga-kerja/pelamar/kota', {
      headers: {
    ...
    const formattedData: PelamarKota[] = data.data.map((item: PelamarKota) => ({
