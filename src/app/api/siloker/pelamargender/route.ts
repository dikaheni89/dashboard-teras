...
export interface PelamarGender {
...
export async function GET() {
  try {
    const responseAPI = await fetch(URL_DASHBOAD + 'teras-tenaga-kerja/pelamar/gender', {
      headers: {
    ...
    const formattedData: PelamarGender[] = data.data.map((item: PelamarGender) => ({
