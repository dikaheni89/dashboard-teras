...
export async function GET() {
  try {
    const responseAPI = await fetch(URL_DASHBOAD + 'teras-tenaga-kerja/lowongan/kota', {
      headers: {
    ...
    const formattedData: LowonganKota[] = data.data.map((item: LowonganKota) => ({
