...
export interface LowonganKategori {
...
export async function GET() {
  try {
    const responseAPI = await fetch(URL_DASHBOAD + 'teras-tenaga-kerja/lowongan/kategori', {
      headers: {
    ...
    const formattedData: LowonganKategori[] = data.data.map((item: LowonganKategori) => ({
      jumlah_lowongan: item.jumlah_lowongan,
