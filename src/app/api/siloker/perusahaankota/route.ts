...
export interface PerusahaanKota {
...
export async function GET() {
  try {
    const responseAPI = await fetch(URL_DASHBOAD + 'teras-tenaga-kerja/perusahaan/kota', {
      headers: {
    ...
    const formattedData: PerusahaanKota[] = data.data.map((item: PerusahaanKota) => ({
      jumlah_perusahaan: item.jumlah_perusahaan,
