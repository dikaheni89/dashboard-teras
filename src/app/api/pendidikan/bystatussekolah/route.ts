...
export interface ByStatusSekolah {
...
export async function GET() {
  try {
    const responseAPI = await fetch(URL_DASHBOAD + 'teras-pendidikan/statussekolah', {
      headers: {
    ...
    const formattedData: ByStatusSekolah[] = data.data.map((item: ByStatusSekolah) => ({
