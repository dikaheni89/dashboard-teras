...
export async function GET() {
  try {
    const responseAPI = await fetch(URL_DASHBOAD + 'teras-kepegawaian/pegawai-by-pendidikan', {
      headers: {
    ...
    const formattedData: ByPendidikan[] = data.data.map((item: ByPendidikan) => ({
