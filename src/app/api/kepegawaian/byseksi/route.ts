...
export async function GET() {
  try {
    const responseAPI = await fetch(URL_DASHBOAD + 'teras-kepegawaian/pegawai-by-section', {
      headers: {
    ...
    const formattedData: BySeksi[] = data.data.map((item: BySeksi) => ({
